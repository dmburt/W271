...
SET ip.[HRR_FY2012_DISCHARGES_EXCLUDING_HOSP]       = hrr.[HRR_FY2012_DISCHARGES_EXCLUDING_HOSP],
	...
	ip.[HRR_FY2014_DISCHARGES_EXCLUDING_HOSP]       = hrr.[HRR_FY2014_DISCHARGES_EXCLUDING_HOSP],
	ip.[HRR_FY2014_AVG_CHG_EXCLUDING_HOSP]          = hrr.[HRR_FY2014_AVG_CHG_EXCLUDING_HOSP],
    ip.[HRR_FY2014_ADJUSTED_AVG_CHG_EXCLUDING_HOSP] = hrr.[HRR_FY2014_ADJUSTED_AVG_CHG_EXCLUDING_HOSP]
