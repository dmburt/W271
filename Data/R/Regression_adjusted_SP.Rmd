...
ggplot(data = d, aes(HRR_PERCENT_URBAN, DIFF_14_13_ADJUSTED_AVG_CHG, colour = factor(URBAN_RURAL_IND))) + 
  geom_point() + geom_smooth(method = 'lm') + labs(colour = "Provider \nU/R Status")
...
#same trend as urban/rural, though interaction effect looks potentially bigger
...
adj_model9 = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
...
#add interaction
adj_model10 = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
...
stargazer(adj_model4, adj_model7, adj_model8,adj_model9,adj_model10,
          type = "text"
          , se = list(se_adj_model4, se_adj_model7, se_adj_model8,se_adj_model9, se_adj_model10))
...
#d$FY2014_DISCHARGES_PER_BED = d$N_FY2014_DISCHARGES/d$BED_CNT

#d$DIFF_14_13_DISCHARGES_PER_BED = d$FY2014_DISCHARGES_PER_BED - d$FY2013_DISCHARGES_PER_BED
...
ggplot(d, aes(FY2013_DISCHARGES_PER_BED, DIFF_14_13_ADJUSTED_AVG_CHG)) + 
  geom_point() + geom_smooth(method = 'lm') +
  ggtitle("discharges per bed by adjusted charges")

adj_model11 = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
...
stargazer(adj_model10, adj_model11,
          type = "text", se = list(se_adj_model10, se_adj_model11 ))
...
adj_model12 = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
...
stargazer(adj_model11, adj_model12,
          type = "text", se = list(se_adj_model11, se_adj_model12 ))
...
adj_model13 = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
                  ...
                  OWNERSHIP_FOR_PROFIT * FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN )
se_adj_model13 = robust.se(adj_model13)[,2]

stargazer(adj_model12, adj_model13,
          type = "text", se = list(se_adj_model12, se_adj_model13 ))
AIC(adj_model12, adj_model13)

ggplot(data = d, aes(FY2013_ADJUSTED_AVG_CHG_RELATIVE_IN, DIFF_14_13_ADJUSTED_AVG_CHG, colour = factor(OWNERSHIP_FOR_PROFIT))) + 
  geom_point() + geom_smooth(method = 'lm') + labs(colour = "for Profit")

stargazer(adj_model13,
          type = "text", se = list(se_adj_model13 ))

#compare in vs out
adj_model13_ex = lm(data = d, DIFF_14_13_ADJUSTED_AVG_CHG ~ FY2013_ADJUSTED_AVG_CHG_RELATIVE_EX +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
...
se_adj_model13_ex = robust.se(adj_model13_ex)[,2]

stargazer(adj_model13,adj_model13_ex,
          type = "text", se = list(se_adj_model13,se_adj_model13_ex ))

#adjusted against unadjusted
non_adj_model13 = lm(data = d, DIFF_14_13_AVG_CHG ~ FY2013_AVG_CHG_RELATIVE_IN +
                  BENEFICIARIES_PER_PROVIDER + 
                  BED_CNT_PER_THOUSAND_BENEFICIARIES +
                  HRR_PERCENT_URBAN +
                  HRR_PERCENT_RESIDENT +
                  ...
                  CHANGE_OF_OWNERSHIP_IN_PERIOD +
                  OWNERSHIP_FOR_PROFIT +
                  OWNERSHIP_FOR_PROFIT * FY2013_AVG_CHG_RELATIVE_IN )
se_adj_model13nonad = robust.se(non_adj_model13)[,2]

stargazer(adj_model13,non_adj_model13,
          type = "text", se = list(se_adj_model13,se_adj_model13nonad ))
```